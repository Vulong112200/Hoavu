		...
		public function __construct(){
			...
			switch ($act) {
				...
				//	$content = $_POST["content"];
					$this->Model->execute("update mvtl set tenMV='$name',id='$iduser' where maMV='$id' ");
					...
					if(strlen($_FILES["image"]["name"]) != ""){
						...
						$this->Model->execute("update mvtl set Anh='$image' where maMV='$id'");
					}
					if(strlen($_FILES["mv"]["name"]) != ""){
						...
						$this->Model->execute("update mvtl set Link='$link' where maMV='$id'");
					}


					echo "<meta http-equiv='refresh' content='0; URL=index.php?controller=mvtl/detail&id=$id'>";
					break;
			...
			include "views/mvtl/editView.php";
		}	
	}
	new EditMV();
