			...
			<form action="index.php?controller=tailen&act=addbh&id=<?php echo $_SESSION["id"] ?>" method="post" enctype="multipart/form-data">
				<table cellpadding="3" style="width: 100%;">
					...
					<tr>
						<th>Link nhạc</th>
						<td>
							<input type="file" name="song" style="padding-top: 10px;" required>
						</td>
					</tr>
				</table>
				<center>
			...
			<form action="index.php?controller=tailen&act=addmv&id=<?php echo $_SESSION["id"] ?>" method="post" enctype="multipart/form-data">
				<table cellpadding="3" style="width: 100%">
					<tr>
						...
						<td width="90%">
							<input type="text" name="name2" placeholder="Tên MV" class="form-control" required>
						</td>
					</tr>
					<!-- upload image -->
					<tr>
						<th>Ảnh</th>
						<td>
							<input type="file" name="image2" style="padding-top: 10px;" required>
						</td>
					</tr>
					<tr>
						<th>Link MV</th>
